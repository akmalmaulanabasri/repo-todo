...
<div class="container">
    <div class="card shadow">
        ...
        <div class="card-body">
            <form action="{{ route('buat-pelajaran') }}" method="POST" class="form-group">
                @csrf
                ...
                <input type="text" name="guru" id="guru" class="form-control @error('guru')is-invalid @enderror" value="{{ old('guru') }}">
                    @error('guru')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <input type="text" name="jam" id="jam" class="form-control @error('jam')is-invalid @enderror" value="{{ old('jam') }}">
                    @error('jam')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <input type="text" name="ruangan" id="ruangan" class="form-control @error('ruangan')is-invalid @enderror" value="{{ old('ruangan') }}">
                    @error('ruangan')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <input type="submit" value="Tambah Pelajaran" class="btn btn-success mt-3">
            </form>
        </div>
    </div>
</div>
